  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-border-default bg-bg-surface md:flex">
      <div className="flex h-16 items-center gap-3 border-b border-border-default px-6">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-text-primary dark:bg-brand-green">
          <Landmark className="h-4 w-4 text-brand-green dark:text-black" />
        </div>
        <span className="text-lg font-bold tracking-tight text-text-primary dark:text-brand-green">
          OLYMPIA
        </span>
      </div>
